...
export const apiProviderCandidates = [
  {
    ...
    nextStep: "补活动页半结构化解析：提取套餐档位、价格、模型覆盖、工具兼容和限额口径；解析稳定前只留后台候选，不进入前台正式报价。",
    notes: "官方入口已确认；当前问题是价格和限制字段还没有稳定结构化。",
  ...
  },
  {
    ...
    nextStep: "补腾讯云官方文档解析器：提取 Lite/Pro 档位、月费、5 小时/周/月请求限额、支持模型和购买页；确认字段完整后再决定是否转正式报价。",
    notes: "官方来源已确认；暂不使用第三方整理站价格作为前台报价依据。",
    updatedAt: apiModelUpdatedAt,
  },
  {
    id: "jdcloud-joyai",
